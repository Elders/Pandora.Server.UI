...
namespace Elders.Pandora.Server.UI.ViewModels
{
    ...
    public class Cluster
    {
        ...
        public Cluster(string name, Access access)
        {
            Name = name;
            Access = access;
        }
    ...
    public static class AccessExtensions
    {
        ...
        public static string AccessToken(this IPrincipal self)
        {
            if (self is ClaimsPrincipal)
                return (self as ClaimsPrincipal).Claims.Where(x => x.Type == "access_token").FirstOrDefault().Value;
            else
                return string.Empty;
        }
        ...
        public static string FullName(this IPrincipal self)
        {
            if (self is ClaimsPrincipal)
            {
                var fullname = (self as ClaimsPrincipal).Claims.Where(x => x.Type == ClaimTypes.Name).FirstOrDefault();
        ...
        public static string FirstName(this IPrincipal self)
        {
            if (self is ClaimsPrincipal)
            {
                var firstname = (self as ClaimsPrincipal).Claims.Where(x => x.Type == ClaimTypes.GivenName).FirstOrDefault();
        ...
        public static string LastName(this IPrincipal self)
        {
            if (self is ClaimsPrincipal)
            {
                var lastname = (self as ClaimsPrincipal).Claims.Where(x => x.Type == ClaimTypes.Surname).FirstOrDefault();
        ...
        public static string Avatar(this IPrincipal self)
        {
            if (self is ClaimsPrincipal)
            {
                var fullname = (self as ClaimsPrincipal).Claims.Where(x => x.Type == "avatar").FirstOrDefault();
        ...
        public static string Email(this IPrincipal self)
        {
            if (self is ClaimsPrincipal)
            {
                var email = (self as ClaimsPrincipal).Claims.Where(x => x.Type == ClaimTypes.Email).FirstOrDefault();
        ...
        public static string Id(this IPrincipal self)
        {
            if (self is ClaimsPrincipal)
            {
                var id = (self as ClaimsPrincipal).Claims.Where(x => x.Type == ClaimTypes.NameIdentifier).FirstOrDefault();
